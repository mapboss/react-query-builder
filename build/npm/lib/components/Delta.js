...
function (_Component) {
  ...
  function Delta() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Delta)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Delta, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "widget--delta widget--delta-".concat(this.props.delta)
      }, [_react.default.createElement("div", {
        key: "widget",
        className: "widget--widget"
      }, this.props.children[0]), this.props.children[1] ? _react.default.createElement("div", {
        key: "options",
...
_defineProperty(Delta, "propTypes", {
