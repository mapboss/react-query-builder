...
var Group = (_temp = _class = (0, _GroupContainer.default)(_class2 =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(Group, [{
    ...
    value: function render() {
      ...
      }, (0, _map.default)(this.props.conjunctionOptions, function (item, index) {
        return _react.default.createElement("div", {
          key: index,
          className: "conjunction conjunction--".concat(index.toUpperCase()),
      ...
      }, this.props.allowFurtherNesting ? _react.default.createElement("button", {
        className: "action action--ADD-GROUP",
        onClick: this.props.addGroup
      }, "Add group") : null, _react.default.createElement("button", {
        className: "action action--ADD-RULE",
        onClick: this.props.addRule
      }, "Add rule"), this.props.allowRemoval ? _react.default.createElement("button", {
        className: "action action--DELETE",
        onClick: this.props.removeSelf
      }, "Delete") : null)), this.props.children ? _react.default.createElement("div", {
  ...
  allowRemoval: _propTypes.default.bool.isRequired
}), _temp);
